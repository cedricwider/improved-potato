...
-- Call autorandr and restart awesome when screen changes.
_G.awesome.connect_signal("screen::change", function(output, connection_state)
	_G.awesome.spawn("autorandr -c", true, false, false, false, function(exit_code, exit_signal)
		if exit_signal == 0 then
			_G.awesome.restart()
		else
			_G.awesome.spawn("arandr", true, false, false, false, function()
				_G.awesome.restart()
			end)
		end
	end)
